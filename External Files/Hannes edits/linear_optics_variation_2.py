...
pdr = xt.Environment()
pdr.particle_ref = xt.Particles(kinetic_energy0=constants.E0, mass0 = xt.ELECTRON_MASS_EV)
...
# mux_cell = 0.25; muy_cell = 0.25; WP = (15.41,15.35) # WP = (15.42,15.38)
# mux_cell = 0.24; muy_cell = 0.25; WP = (15.3600000038,15.400000042) ######
# mux_cell = 0.239; muy_cell = 0.25; WP = (15.3600000038,15.400000042) ############
# mux_cell = 0.24; muy_cell = 0.228; WP = (15.3600000038,14.400000042) ######
# mux_cell = 0.242; muy_cell = 0.228; WP = (15.3600000038,14.400000042) 
# mux_cell = 0.241; muy_cell = 0.227; WP = (15.3500000038,14.390000042) 
# mux_cell = 0.241; muy_cell = 0.220; WP = (15.3600000038,14.400000042) 
# mux_cell = 0.244; muy_cell = 0.218; WP = (15.3600000038,14.400000042) ######
# mux_cell = 0.246; muy_cell = 0.218; WP = (15.3600000038,14.400000042) ##################
# mux_cell = 0.246; muy_cell = 0.212; WP = (15.3600000038,14.400000042) ####
# mux_cell = 0.286; muy_cell = 0.218; WP = (17.3600000038,14.400000042)
# mux_cell = 0.286; muy_cell = 0.238; WP = (17.3600000038,15.400000042) ##
# mux_cell = 0.286; muy_cell = 0.228; WP = (17.3600000038,15.400000042)
# mux_cell = 0.286; muy_cell = 0.233; WP = (17.3600000038,15.400000042) ###
# mux_cell = 0.286; muy_cell = 0.235; WP = (17.3600000038,15.400000042)
# mux_cell = 0.246; muy_cell = 0.223; WP = (15.3600000038,14.400000042) 
# mux_cell = 0.239; muy_cell = 0.25; WP = (14.3600000038,15.400000042) #
# mux_cell = 0.239; muy_cell = 0.235; WP = (14.3600000038,15.400000042) ######################
# mux_cell = 0.239; muy_cell = 0.218; WP = (15.3600000038,14.400000042) #####
# mux_cell = 0.245; muy_cell = 0.195; WP = (15.3600000038,13.400000042) #
mux_cell = 0.25; muy_cell = 0.18; WP = (15.3600000038,12.400000042) #######################
pdr.vars({'l_cell': 3.4,'l_bend': 0.4,'l_bendDS': 'l_bend','dl_noben': 0.25+0.6, 'l_quad': 0.30,
  'l_drift': '(l_cell - 2*l_bend - 2*l_quad)/4.','dl_drift': -0.0, 'dl_trans': 0.20,
  'l_doub':  0.25, 'l_tripl': 2.7, 'l_trips': 0.40, 'l_sext': 0.20, })

# mux_cell = 0.246; muy_cell = 0.218; WP = (15.3600000038,14.400000042) ############
# pdr.vars({'l_cell': 3.439,'l_bend': 0.4,'l_bendDS': 'l_bend', 'dl_noben': 0.25+0.6, 'l_quad': 0.30,
#   'l_drift': '(l_cell - 2*l_bend - 2*l_quad)/4.','dl_drift': -0.0, 'dl_trans': 0.20,
#   'l_doub':  0.25, 'l_tripl': 2.7, 'l_trips': 0.40, 'l_sext': 0.20, })


# mux_cell = 0.25; muy_cell = 3/14; WP = (15.38,14.42)
# pdr.vars({'l_cell': 3.4,'l_bend': 0.35,'l_bendDS': 0.35,'dl_noben': 0.25+0.6, 'l_quad': 0.30,
#   'l_drift': '(l_cell - 2*l_bend - 2*l_quad)/4.','dl_drift': -0.0, 'dl_trans': 0.20,
#   'l_doub':  0.25, 'l_tripl': 2.7, 'l_trips': 0.40, 'l_sext': 0.20, })

# mux_cell = 4/14; muy_cell = 3/14; WP = (17.38,14.42) # (17.13000038,14.180000042)
# pdr.vars({'l_cell': 3.4,'l_bend': 0.35,'l_bendDS': 0.35,'dl_noben': 0.25+0.6, 'l_quad': 0.30,
#   'l_drift': '(l_cell - 2*l_bend - 2*l_quad)/4.','dl_drift': -0.0, 'dl_trans': 0.20,
#   'l_doub':  0.25, 'l_tripl': 2.7, 'l_trips': 0.40, 'l_sext': 0.20, })
...
# OLD stuff
# settings for the higher phase advance (mux_cell = 4./14., muy_cell = 3/14) WP = (17.38,14.42)
# mux_cell = 4./14.; muy_cell = 3/14; WP = (17.38,14.42)
# pdr.vars({'l_cell': 3.4,'l_bend': 0.35,'l_bendDS': 0.35,'dl_noben': 0.25, 'l_quad': 0.30,
#   'l_drift': '(l_cell - 2*l_bend - 2*l_quad)/4.','dl_drift': -0.1, 'dl_trans': 0.00,
#   'l_doub':  0.25, 'l_tripl': 2.7, 'l_trips': 0.40, 'l_sext': 0.20, })

# pdr.vars({'l_cell': 3.4,'l_bend': 0.40,'l_bendDS': 0.40,'dl_noben': 0.25, 'l_quad': 0.30,
#   'l_drift': '(l_cell - 2*l_bend - 2*l_quad)/4.','dl_drift': -0.1, 'dl_trans': 0.00,
#   'l_doub':  0.25, 'l_tripl': 2.7, 'l_trips': 0.40, 'l_sext': 0.20, })
'''
...
# pdr.vars({'N_cells_S': 8,'hBarc' : '6.283185307/(6*(2*N_cells_S*l_bend + l_bendDS))',
#   'kQFarc': 2.6032, 'kQDarc':-2.407,'kQFarcM': 2.590, 'kQDarcM':-2.081, 
#   'kQFDS': 2.296, 'kQDDS':-1.8184, 'kQFDoub': 4.20685, 'kQDDoub':-4.16231, 
#   'kQFtr': 5.528, 'kQDtr':-4.2766,  } )


"""
# for longer damping ring
mux_cell = 0.25; muy_cell = 0.235; WP = (27.3600000038,26.400000042) ############
pdr.vars({'l_cell': 3.4,'l_bend': 0.5,'l_bendDS': 0.5,'dl_noben': 0.25+0.6, 'l_quad': 0.30,
  'l_drift': '(l_cell - 2*l_bend - 2*l_quad)/4.','dl_drift': -0.0, 'dl_trans': 0.20,
  'l_doub':  0.25, 'l_tripl': 2.7, 'l_trips': 0.40, 'l_sext': 0.20, })
pdr.vars({'N_cells_S': 16,'hBarc' : '6.283185307/(6*(2*N_cells_S*l_bend + l_bendDS))',
  'kQFarc': 2.9478, 'kQDarc':-2.9231,'kQFarcM': 2.8846, 'kQDarcM':-2.7567, 
  'kQFDS': 2.8042, 'kQDDS':-2.2858, 'kQFDoub': 3.9170, 'kQDDoub':-2.5190, 
  'kQFtr': 4.4429, 'kQDtr':-2.4723,  } )
#"""
...
N_bends_total = 6*(2*pdr['N_cells_S']+1)
B0_T = 3.33 * constants.E0/1e9 / pdr['l_bend'] * 2*np.pi/N_bends_total
pdr.vars({'B0_T': B0_T})
# print("Bending field: %1.2f T"%B0_T)
...
cell_arc_opt = cell_arc.match( method='4d', solve=True, verbose=False,
    ...
    targets=[
        xt.TargetSet(qx=mux_cell, qy=muy_cell, tol=1.0e-6, tag='end'), # just twice the same 
        xt.TargetSet(mux=mux_cell, muy=muy_cell, at=xt.END, tol=1.0e-6)]  )
...
# matchingWP(*constants.WP, MakePlot=True)
matchingWP(*WP, MakePlot=False)
...
# tw.plot()
# ring.survey().plot() 
# print(tw.circumference, tw.qx, tw.qy)

ring_copy = ring.copy(shallow=True)
ring_copy.cut_at_s(np.linspace(0, ring_copy.get_length(), 10000, endpoint=False))
tw = ring_copy.twiss()
tw.plot()
plt.xlim(0,tw.circumference/6)
# print(tw.circumference, tw.qx, tw.qy)

# %%

""
plot = xplt.TwissPlot(tw, line=ring, kind="bet-dx")
axs = plot.fig.get_axes()
axs[1].set_xlim(0,tw.circumference/6)
axs[2].set_ylim(0,3)
